...
export const ReporteEHShow = () => (
    <Show>
        <SimpleShowLayout>
            ...
            <TextField source="paciente_domicilio_alcaldia" label="Domicilio - Alcaldía o municipio" />
            ...
            <BooleanField source="paro_cardiorrespiratorio" label="Paro cardiorrespiratorio" />
            <TextField source="calidad_pulso" label="Calidad del pulso" />
            <TextField source="piel_estado" label="Estado de la piel" />
            <TextField source="caracteristicas_piel" label="Características de la piel" />
            <TextField source="observaciones_adicionales" label="Observaciones adicionales" />
            ...
            <TextField source="padecimientos_cirugias" label="Padecimientos/Cirugías" />
            ...
            <BooleanField source="intubacion_orotraqueal" label="Intubación orotraqueal" />
            <BooleanField source="combitubo" label="Combitubo" />
            <BooleanField source="intubacion_nasotraqueal" label="Intubación nasotraqueal" />
            <BooleanField source="mascarilla_laringea" label="Mascarilla laríngea" />
            <BooleanField source="cricotiroidotomia" label="Cricotiroidotomía por punción" />
            ...
            {/* Asistencia ventilatoria */}
            <h2>Asistencia ventilatoria</h2>
            <BooleanField source="balon_valvula_mascarilla" label="Balón válvula mascarilla" />
            ...
            <BooleanField source="ventilador_automatico" label="Ventilador automático" />
            <BooleanField source="hemitorax_derecho_trat" label="Hemitórax derecho" />
            <BooleanField source="hemitorax_izquierdo_trat" label="Hemitórax izquierdo" />
            <BooleanField source="descompresion_pleural" label="Descompresión pleural con agua" />
            <BooleanField source="mascarilla_reservorio" label="Mascarilla con reservorio" />
            ...
            <BooleanField source="inmovilizacion_extremidades" label="Inmovilización de extremidades" />
            ...
            {/* Datos Legales */}
            <h2>Datos Legales</h2>
            <TextField source="autoridades_conocimiento" label="Autoridades que tomaron conocimiento" />
...
const emergencyFilters = [
    ...
    <SelectInput source="secciones_adicionales" label="Tipo de emergencia" choices={[
        { id: 'ninguna', name: 'Ninguna' },
        { id: 'parto', name: 'Parto' },
        { id: 'causa_traumatica', name: 'Causa Traumática' },
        { id: 'accidente_automovilistico', name: 'Accidente Automovilístico' },
