  ...
  return (
    <Edit mutationOptions={{ onSuccess }}>
      <SimpleForm warnWhenUnsavedChanges>
        ...
        <TimeInput
          source="hora_ingreso_hospital"
          label="Hora de ingreso al hospital"
        />
        <TimeInput
          source="hora_salida_hospital"
          label="Hora de salida del hospital"
        />
        ...
        <TextInput
          source="matricula_helicoptero"
          label="Matrícula helicóptero"
        />
        ...
        />
        <TextInput
          source="paciente_domicilio_calle"
          label="Domicilio - Calle"
          fullWidth
        />
        <TextInput
          source="paciente_domicilio_colonia"
          label="Domicilio - Colonia"
          fullWidth
        />
        <TextInput
          source="paciente_domicilio_alcaldia"
          label="Domicilio - Alcaldía o municipio"
          fullWidth
        />
              ...
              <>
                ...
                {seccionSeleccionada === "parto" && (
                  <>
                    ...
                    <NumberInput
                      source="semanas_gesta"
                      label="Semanas de gesta"
                    />
                    <TimeInput
                      source="hora_inicio_contracciones"
                      label="Hora de inicio de contracciones"
                    />
                    <TextInput
                      source="frecuencia_contracciones"
                      label="Frecuencia de contracciones"
                    />
                    <TextInput
                      source="duracion_contracciones"
                      label="Duración"
                    />

                    <h2>Datos del recién nacido y postparto</h2>
                    <TimeInput
                      source="hora_nacimiento"
                      label="Hora del nacimiento"
                    />
                    <BooleanInput
                      source="placenta_expulsada"
                          ...
                          <>
                            ...
                            {seccionSeleccionada === "color" && (
                              <>
                                ...
                                <h3>1 Minuto</h3>
                                <SelectInput
                                  source="color_1_minuto"
                                  label="Color 1 Minuto"
                                  choices={ColorChoices}
                                />
                                <h3>5 Minutos</h3>
                                <SelectInput
                                  source="color_5_minutos"
                                  label="Color 5 Minutos"
                                  choices={ColorChoices}
                                />
                                <h3>10 Minutos</h3>
                                <SelectInput
                                  source="color_10_minutos"
                                  label="Color 10 Minutos"
                                  choices={ColorChoices}
                                />
                                <h3>15 Minutos</h3>
                                <SelectInput
                                  source="color_15_minutos"
                                  label="Color 15 Minutos"
                                  choices={ColorChoices}
                                />
                                <h3>20 Minutos</h3>
                                <SelectInput
                                  source="color_20_minutos"
                                  label="Color 20 Minutos"
                                  choices={ColorChoices}
                                />
                              </>
                            )}
                            ...
                            {seccionSeleccionada === "fc" && (
                              <>
                                ...
                                <SelectInput
                                  source="fc_1_minuto"
                                  label="Frecuencia Cardiaca 1 Minuto"
                                  choices={FCChoices}
                                />
                                <h3>5 Minutos</h3>
                                <SelectInput
                                  source="fc_5_minutos"
                                  label="Frecuencia Cardiaca 5 Minutos"
                                  choices={FCChoices}
                                />
                                <h3>10 Minutos</h3>
                                <SelectInput
                                  source="fc_10_minutos"
                                  label="Frecuencia Cardiaca 10 Minutos"
                                  choices={FCChoices}
                                />
                                <h3>15 Minutos</h3>
                                <SelectInput
                                  source="fc_15_minutos"
                                  label="Frecuencia Cardiaca 15 Minutos"
                                  choices={FCChoices}
                                />
                                <h3>20 Minutos</h3>
                                <SelectInput
                                  source="fc_20_minutos"
                                  label="Frecuencia Cardiaca 20 Minutos"
                                  choices={FCChoices}
                                />
                              </>
                            )}
                            ...
                            {seccionSeleccionada ===
                              ...
                              <>
                                ...
                                <h3>1 Minuto</h3>
                                <SelectInput
                                  source="irritabilidad_refleja_1_minuto"
                                  label="Irritabilidad Refleja 1 Minuto"
                                  choices={IrritabilidadReflejaChoices}
                                />
                                <h3>5 Minutos</h3>
                                <SelectInput
                                  source="irritabilidad_refleja_5_minutos"
                                  label="Irritabilidad Refleja 5 Minutos"
                                  choices={IrritabilidadReflejaChoices}
                                />
                                <h3>10 Minutos</h3>
                                <SelectInput
                                  source="irritabilidad_refleja_10_minutos"
                                  label="Irritabilidad Refleja 10 Minutos"
                                  choices={IrritabilidadReflejaChoices}
                                />
                                <h3>15 Minutos</h3>
                                <SelectInput
                                  source="irritabilidad_refleja_15_minutos"
                                  label="Irritabilidad Refleja 15 Minutos"
                                  choices={IrritabilidadReflejaChoices}
                                />
                                <h3>20 Minutos</h3>
                                <SelectInput
                                  source="irritabilidad_refleja_20_minutos"
                                  label="Irritabilidad Refleja 20 Minutos"
                                  choices={IrritabilidadReflejaChoices}
                                />
                              </>
                            )}
                            ...
                            {seccionSeleccionada === "tono_muscular" && (
                              <>
                                ...
                                <h3>1 Minuto</h3>
                                <SelectInput
                                  source="tono_muscular_1_minuto"
                                  label="Tono Muscular 1 Minuto"
                                  choices={TonoMuscularChoices}
                                />
                                <h3>5 Minutos</h3>
                                <SelectInput
                                  source="tono_muscular_5_minutos"
                                  label="Tono Muscular 5 Minutos"
                                  choices={TonoMuscularChoices}
                                />
                                <h3>10 Minutos</h3>
                                <SelectInput
                                  source="tono_muscular_10_minutos"
                                  label="Tono Muscular 10 Minutos"
                                  choices={TonoMuscularChoices}
                                />
                                <h3>15 Minutos</h3>
                                <SelectInput
                                  source="tono_muscular_15_minutos"
                                  label="Tono Muscular 15 Minutos"
                                  choices={TonoMuscularChoices}
                                />
                                <h3>20 Minutos</h3>
                                <SelectInput
                                  source="tono_muscular_20_minutos"
                                  label="Tono Muscular 20 Minutos"
                                  choices={TonoMuscularChoices}
                                />
                              </>
                            )}
                            ...
                            {seccionSeleccionada === "respiracion" && (
                              <>
                                ...
                                <h3>1 Minuto</h3>
                                <SelectInput
                                  source="respiracion_1_minuto"
                                  label="Respiración 1 Minuto"
                                  choices={RespiracionChoices}
                                />
                                <h3>5 Minutos</h3>
                                <SelectInput
                                  source="respiracion_5_minutos"
                                  label="Respiración 5 Minutos"
                                  choices={RespiracionChoices}
                                />
                                <h3>10 Minutos</h3>
                                <SelectInput
                                  source="respiracion_10_minutos"
                                  label="Respiración 10 Minutos"
                                  choices={RespiracionChoices}
                                />
                                <h3>15 Minutos</h3>
                                <SelectInput
                                  source="respiracion_15_minutos"
                                  label="Respiración 15 Minutos"
                                  choices={RespiracionChoices}
                                />
                                <h3>20 Minutos</h3>
                                <SelectInput
                                  source="respiracion_20_minutos"
                                  label="Respiración 20 Minutos"
                                  choices={RespiracionChoices}
                                />
                              </>
                            )}
                  ...
                  <>
                    ...
                    <SelectInput
                      ...
                      choices={[
                        ...
                        {
                          id: "sustancia_caliente",
                          name: "Sustancia caliente",
                        },
                        { id: "sustancia_toxica", name: "Sustancia tóxica" },
                        {
                          id: "producto_biologico",
                          name: "Producto biológico",
                        },
                    ...
                    />
                    <TextInput
                      source="agente_causal_otro"
                      label="Otro (especificar)"
                    />
                    <TextInput
                      source="descripcion_traumatica"
                      label="Descripción"
                      multiline
                      rows={3}
                    />
                  ...
                  <>
                    ...
                    <SelectInput
                      ...
                      choices={[
                        ...
                        { id: "maquinaria", name: "Maquinaria" },
                        {
                          id: "contra_objeto_fijo",
                          name: "Contra Objeto fijo",
                        },
                      ]}
                    />
                  ...
                  <>
                    ...
                    <SelectInput
                      ...
                      choices={[
                        ...
                        {
                          id: "cognitivo_emocional",
                          name: "Cognitivo emocional",
                        },
                        { id: "otro", name: "Otro" },
                      ]}
                    />
                    <TextInput
                      source="origen_probable_otro"
                      label="Otro (especificar)"
                    />
        ...
        <BooleanInput
          source="paro_cardiorrespiratorio"
        ...
        <TextInput
          source="observaciones_adicionales"
          label="Observaciones adicionales"
          multiline
          rows={3}
        />

        {/* Exploración Física y Zonas de Lesión (Imagen) */}
        <h2>Exploración Física y Zonas de Lesión</h2>
        <ImageInput
          source="imagen"
          label="Imagen de la exploración física y zonas de lesión"
        >
        ...
        <SelectInput
          source="apertura_ocular"
          choices={AperturaOcularChoices}
          label="Apertura ocular"
        />
        <SelectInput
          source="respuesta_motora"
          choices={RespuestaMotoraChoices}
          label="Respuesta motora"
        />
        <SelectInput
          source="respuesta_verbal"
          choices={RespuestaVerbalChoices}
        ...
        />
        <TextInput
          source="padecimientos_cirugias"
          label="Padecimientos/Cirugías"
          multiline
          rows={2}
        />
        <TextInput
          source="ultima_comida"
          label="Última comida"
          multiline
          rows={2}
        />
        <TextInput
          source="eventos_previos"
        ...
        <BooleanInput
          source="balon_valvula_mascarilla"
        ...
        <BooleanInput
          source="ventilador_automatico"
          label="Ventilador automático"
        />
        <BooleanInput
          source="hemitorax_derecho_trat"
          label="Hemitórax derecho"
        />
        <BooleanInput
          source="hemitorax_izquierdo_trat"
          label="Hemitórax izquierdo"
        />
        <BooleanInput
          source="descompresion_pleural"
          label="Descompresión pleural con agua"
        />
        <BooleanInput
          source="mascarilla_reservorio"
        ...
        <BooleanInput
          source="inmovilizacion_extremidades"
        ...
        <TextInput
          source="observaciones_tratamiento"
          label="Observaciones"
          multiline
          rows={3}
        />
        ...
        <TextInput
          source="pertenencias"
          label="Escribir pertenencias separadas por nueva línea (ENTER)"
          multiline
          rows={2}
        />
        ...
        <h2>Datos Legales</h2>
        <TextInput
          source="autoridades_conocimiento"
          label="Autoridades que tomaron conocimiento"
          multiline
          rows={2}
        />
...
export const ReporteEHShow = () => (
  <Show>
    <SimpleShowLayout>
      ...
      <TextField source="hora_salida" label="Hora de salida" />
      ...
      <TextField source="colonia" label="Colonia o comunidad" />
      ...
      <TextField source="lugar_ocurrencia_otra" label="Otra (especificar)" />
      ...
      <TextField source="matricula_helicoptero" label="Matrícula helicóptero" />
      ...
      <TextField source="derechohabiente_otra" label="Otra (especificar)" />
      <TextField source="paciente_telefono" label="Teléfono" />
      <TextField source="paciente_ocupacion" label="Ocupación" />

      {/* Secciones Adicionales */}
      <h2>Tipo de Emergencia</h2>
      <TextField source="secciones_adicionales" label="Secciones adicionales" />

      {/* Evaluación Inicial */}
      <h2>Evaluación Inicial</h2>
      <TextField source="nivel_conciencia" label="Nivel de conciencia" />
      <TextField source="deglucion" label="Deglución" />
      <TextField source="via_aerea" label="Vía aérea" />
      <TextField source="ventilacion" label="Ventilación" />
      <TextField source="ruidos_respiratorios" label="Ruidos respiratorios" />
      <TextField source="hemitorax" label="Hemitórax" />
      <TextField source="sitio_auscultacion" label="Sitio" />
      <BooleanField source="pulso_carotideo" label="Pulso Carotídeo" />
      <BooleanField source="pulso_radial" label="Pulso Radial" />
      <BooleanField
        source="paro_cardiorrespiratorio"
        label="Paro cardiorrespiratorio"
      />
      <TextField source="calidad_pulso" label="Calidad del pulso" />
      <TextField source="piel_estado" label="Estado de la piel" />
      <TextField
        source="caracteristicas_piel"
        label="Características de la piel"
      />
      ...
      {/* Pupilas */}
      <h2>Pupilas</h2>
      <TextField source="pupilas_izquierda" label="Izquierda" />
      <TextField source="pupilas_derecha" label="Derecha" />

      {/* Signos vitales y Monitoreo */}
      <h2>Signos vitales y Monitoreo</h2>
      <TextField source="apertura_ocular" label="Apertura ocular" />
      <TextField source="respuesta_motora" label="Respuesta motora" />
      <TextField source="respuesta_verbal" label="Respuesta verbal" />
      <NumberField source="glasgow_total" label="Glasgow total" />

      {/* Información Previa del Paciente */}
      <h2>Información Previa del Paciente</h2>
      <TextField source="alergias" label="Alergias" />
      <TextField source="medicamentos" label="Medicamentos" />
      <TextField
        source="padecimientos_cirugias"
        label="Padecimientos/Cirugías"
      />
      <TextField source="ultima_comida" label="Última comida" />
      <TextField source="eventos_previos" label="Eventos Previos" />

      {/* Condición y Prioridad */}
      <h2>Condición y Prioridad</h2>
      <TextField source="condicion_paciente" label="Condición del paciente" />
      <TextField source="prioridad" label="Prioridad" />
      ...
      <TextField source="folio_cru" label="Folio CRU" />

      {/* Tratamiento - Vía aérea */}
      <h2>Tratamiento - Vía aérea</h2>
      <BooleanField source="aspiracion" label="Aspiración" />
      <BooleanField source="canula_orofaringea" label="Cánula Orofaríngea" />
      <BooleanField source="canula_nasofaringea" label="Cánula nasofaríngea" />
      <BooleanField
        source="intubacion_orotraqueal"
        label="Intubación orotraqueal"
      />
      <BooleanField source="combitubo" label="Combitubo" />
      <BooleanField
        source="intubacion_nasotraqueal"
        label="Intubación nasotraqueal"
      />
      <BooleanField source="mascarilla_laringea" label="Mascarilla laríngea" />
      <BooleanField
        source="cricotiroidotomia"
        label="Cricotiroidotomía por punción"
      />
      ...
      {/* Control cervical */}
      <h2>Control cervical</h2>
      <BooleanField source="control_manual" label="Manual" />
      <BooleanField source="collarin_rigido" label="Collarín rígido" />
      <BooleanField source="collarin_blando" label="Collarín blando" />
      ...
      <BooleanField
        ...
        label="Balón válvula mascarilla"
      />
      <BooleanField source="valvula_demanda" label="Válvula de demanda" />
      <BooleanField source="hiperventilacion" label="Hiperventilación" />
      <BooleanField source="puntas_nasales" label="Puntas nasales" />
      <BooleanField source="mascarilla_simple" label="Mascarilla simple" />
      <BooleanField
        source="ventilador_automatico"
        label="Ventilador automático"
      />
      <BooleanField source="hemitorax_derecho_trat" label="Hemitórax derecho" />
      <BooleanField
        source="hemitorax_izquierdo_trat"
        label="Hemitórax izquierdo"
      />
      ...
      <BooleanField
        ...
        label="Mascarilla con reservorio"
      />
      <BooleanField source="mascarilla_venturi" label="Mascarilla venturi" />
      <NumberField source="latidos_por_minuto" label="Latidos por minuto" />

      {/* Medicamento */}
      <h2>Medicamento</h2>
      <TextField source="medicamento_hora" label="Hora" />
      <TextField source="medicamento_dosis" label="Dosis" />
      <TextField source="medicamento_nombre" label="Medicamento" />
      <TextField source="via_administracion" label="Vía administración" />
      <TextField source="dr_tratante" label="Dr Tratante" />

      {/* Control de hemorragia */}
      <h2>Control de hemorragia</h2>
      <BooleanField source="presion_directa" label="Presión directa" />
      <BooleanField source="presion_indirecta" label="Presión indirecta" />
      <BooleanField source="gravedad_hemorragia" label="Gravedad" />
      <BooleanField source="vendaje_compresivo" label="Vendaje compresivo" />
      <BooleanField source="crioterapia" label="Crioterapia" />
      <BooleanField source="mast" label="MAST" />

      {/* Vía venosas y tipo de solución */}
      <h2>Vía venosas y tipo de solución</h2>
      <BooleanField source="hartmann" label="Hartmann" />
      <BooleanField source="nacl" label="NaCl 9.9%" />
      <BooleanField source="mixta" label="Mixta" />
      <BooleanField source="glucosa" label="Glucosa 5%" />
      <BooleanField source="otra_solucion" label="Otra" />
      <NumberField source="linea_iv" label="Línea IV" />
      <NumberField source="cateter" label="Catéter" />
      <NumberField source="cantidad_solucion" label="Cantidad" />

      {/* Atención básica */}
      <h2>Atención básica</h2>
      <TextField source="rcp" label="RCP" />
      <BooleanField source="curacion" label="Curación" />
      <BooleanField
        source="inmovilizacion_extremidades"
        label="Inmovilización de extremidades"
      />
      <BooleanField source="empaquetamiento" label="Empaquetamiento" />
      <BooleanField source="vendaje" label="Vendaje" />
      <TextField source="observaciones_tratamiento" label="Observaciones" />

      {/* Pertenencias */}
      <h2>Pertenencias</h2>
      <TextField source="pertenencias" label="Pertenencias" />
      ...
      <TextField source="num_unidad_legal" label="Núm. unidad" />
      <TextField source="num_oficial" label="Núm. de oficial" />

      {/* Vehículos involucrados */}
      <h2>Vehículos involucrados</h2>
      <TextField source="vehiculo_tipo" label="Tipo" />
      <TextField source="vehiculo_marca" label="Marca" />
      <TextField source="vehiculo_placa" label="Placa" />

      {/* Metadatos */}
      <h2>Metadatos</h2>
      <TextField source="creado_por" label="Creado Por" />
      <TextField source="fecha_creacion" label="Fecha de Creación" />
    </SimpleShowLayout>
  </Show>
);
...
const emergencyFilters = [
  ...
  <SelectInput
    ...
    choices={PrioridadChoices}
  />,
  <TextInput source="alcaldia_municipio" label="Alcaldía/Municipio" />,
  <TextInput source="creado_por" label="Creado Por" />,
];
